...
public class DiffyJrCoprocessorBridge extends SubsystemBase {
    ...
    public final JointManager jointPublisher;
    ...
    private final Publisher[] m_publishers;
    ...
    public DiffyJrCoprocessorBridge(DriveSubsystem drive) {
        ...
        jointPublisher = new JointManager(bridge, "joint");
    ...
    private void sendJoints() {
        ...
        for (int moduleIndex = 0; moduleIndex < states.length; moduleIndex++) {
            ...
            jointPublisher.sendJointPosition(JOINT_NAMES[moduleIndex], state.angle.getRadians());
        }
    }
    ...
    public void periodic() {
        ...
        for (Publisher publisher : m_publishers) {
            publisher.publish();
        }
