...
/**
 * A trajectory waypoint, including a translation and optional drive/holonomic
 * rotations.
 */
public class Waypoint {
    ...
    /**
     * Constructs a Waypoint at the origin and without a drive or holonomic
     * rotation.
     */
    public Waypoint() {
    ...
    /**
     * Constructs a Waypoint with a translation, drive rotation, and holonomic
     * rotation.
     *
    ...
    /**
     * Constructs a Waypoint with a translation (but no drive or holonomic
     * rotation).
     *
     * @param translation Waypoint position (required)
     */
     ...
     * Constucts a Waypoint based on a pose.
     *
     * @param pose              Source pose (where the rotation describes the drive
     *                          rotation)
     ...
     * Constucts a Waypoint based on a pose.
     *
     * @param pose          Source pose (where the rotation describes the holonomic
     *                      rotation)
    ...
    /**
     * Returns the drive rotation component of the waypoint (or an empty optional if
     * not specified).
     */
    ...
    /**
     * Returns the holonomic rotation component of the waypoint (or an empty
     * optional if not
     * specified).
     */
