...
/**
 * Represents a sequence of timed rotations. The position and velocity of the
 * robot is calculated to
...
public class RotationSequence {
   ...
   *
   * @param timeSeconds The point in time since the beginning of the rotation
   *                    sequence to sample.
  ...
  public static class State {
     ...
     *
     * @param position              The position at this point in the rotation
     *                              sequence.
     * @param velocityRadiansPerSec The velocity at this point in the rotation
     *                              sequence.
     */
