...
public class Constants {
    ...
    public static class DriveTrain {
        ...
        public static final double MAX_CHASSIS_CENTRIPITAL_ACCEL = 10.0; // Maximum chassis centripital acceleration
                                                                         // (anti-tip) (m/s^2)
        ...
        public static final double MIN_CHASSIS_ANG_VEL = 0.1; // Minimum chassis rotational velocity that isn't zero
                                                              // (rad/s)

        public static final double MAX_BATTERY_SLEW_RATE = 2.0; // How much to dampen the max voltage limit
                                                                // (Volts/second)
    ...
    public static class DifferentialSwerveModule {
        ...
        public static final double FALCON_FREE_SPEED = Units.rotationsPerMinuteToRadiansPerSecond(6380.0); // Radians
                                                                                                           // per second
        ...
        public static final double FALCON_MAX_SPEED_RPS = Units.rotationsPerMinuteToRadiansPerSecond(600.0); // radians
                                                                                                             // per
                                                                                                             // second
        ...
        public static final double AZIMUTH_ROTATIONS_TO_RADIANS = 2.0 * Math.PI; // radians per rotation of azimuth
                                                                                 // sensor
